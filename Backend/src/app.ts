...
import accessPermissionRoutes from './routes/accessPermissionRoutes';
import messageRoutes from './routes/messageRoutes';
import creditRoutes from './routes/creditRoutes';
import posAdvancedRoutes from './routes/posAdvancedRoutes';
...
app.get('/', (req: Request, res: Response) => {
  res.json({
    ...
    endpoints: {
      ...
      accessPermissions: '/api/access-permissions',
...
app.use('/api/v1', posAdvancedRoutes);
app.use('/api/pos-advanced', posAdvancedRoutes);
