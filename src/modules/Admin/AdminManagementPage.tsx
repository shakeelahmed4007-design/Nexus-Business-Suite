    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[400px] text-center p-8 bg-white dark:bg-ink-900 rounded-2xl border border-ink-200 dark:border-ink-800 m-6 shadow-xs">
        ...
        <p className="text-sm text-ink-500 max-w-md mt-1">
          Only the Super Admin has permission to manage Admin accounts, configure system-level roles, and grant shared data access.
        </p>
                            ...
                            <div className="space-y-3 p-4 border-t border-ink-200 dark:border-ink-800">
                              {moduleCat.items.map((subItem) => {
                                ...
                                return (
                                  <div
                                    key={subItem.key}
                                    className={`flex flex-col gap-2.5 rounded-xl border p-3.5 transition-all sm:flex-row sm:items-center sm:justify-between ${flags.access
                                  ...
                                  >
                                    ...
                                    <div className="flex flex-wrap items-center gap-3 pl-7 sm:pl-0">
                                      <label
                                        ...
                                        className={`flex cursor-pointer items-center gap-1.5 rounded-lg border px-2.5 py-1 text-[11px] font-semibold transition-all ${flags.can_create
                                      ...
                                      <label
                                        ...
                                        className={`flex cursor-pointer items-center gap-1.5 rounded-lg border px-2.5 py-1 text-[11px] font-semibold transition-all ${flags.can_edit
                                      ...
                                      <label
                                        ...
                                        className={`flex cursor-pointer items-center gap-1.5 rounded-lg border px-2.5 py-1 text-[11px] font-semibold transition-all ${flags.can_delete
                  ...
                  >
                    ...
                    {!isSuper && (
                      <div className="flex items-center gap-2 pt-1">
                        <button
                          onClick={() => handleToggleStatus(adm.id)}
                          className={`flex-1 rounded-xl py-1.5 text-xs font-semibold transition-colors text-center ${adm.has_data_access
                        ...
                        <td className="px-5 py-4 text-right">
                          {isSuper ? (
                            ...
                            <div className="flex items-center justify-end gap-2">
                              <button
                                onClick={() => handleToggleStatus(adm.id)}
                                className={`rounded-xl px-3 py-1.5 text-xs font-semibold transition-colors cursor-pointer ${adm.has_data_access
                                  ? 'bg-rose-50 text-rose-700 hover:bg-rose-100 dark:bg-rose-950/40 dark:text-rose-300'
                                  : 'bg-emerald-50 text-emerald-700 hover:bg-emerald-100 dark:bg-emerald-950/40 dark:text-emerald-300'
                                  }`}
                              >
